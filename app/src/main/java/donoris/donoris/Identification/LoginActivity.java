...
public class LoginActivity extends AppCompatActivity
{
    ...
    private void AllowingUserToLogin()
    {
        ...
        else
        {
            ...
            loadingBar.setMessage("Veuillez patienter pendant que nous vous permettons de vous connecter à votre compte...");
            loadingBar.show();
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>()
                    {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task)
                        {
                            if (task.isSuccessful())
                            {
                                ...
                                Toast.makeText(LoginActivity.this, "Vous êtes connecté avec succès.", Toast.LENGTH_LONG).show();
                                loadingBar.dismiss();
                            }
                            ...
                            else
                            {
                                ...
                                Toast.makeText(LoginActivity.this, "Erreur survenue: " + message, Toast.LENGTH_LONG).show();
                                loadingBar.dismiss();
                            }
                        }
                    });
